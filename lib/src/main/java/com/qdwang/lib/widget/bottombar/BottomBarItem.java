package com.qdwang.lib.widget.bottombar;
...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        unreadTextColor = ta.getColor(R.styleable.BottomBarItem_unreadTextColor, Color.parseColor("#ffffff"));
        ...
        msgTextColor = ta.getColor(R.styleable.BottomBarItem_msgTextColor, Color.parseColor("#ffffff"));
