...
import com.qdwang.lib.picker.lib.WheelView;
import com.qdwang.lib.picker.listener.CustomListener;
import com.qdwang.lib.picker.view.BasePickerView;
import com.qdwang.lib.picker.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(getContext()).inflate(R.layout.pickerview_time, contentContainer);
            ...
            customListener.customLayout(LayoutInflater.from(getContext()).inflate(layoutRes, contentContainer));
        }
        // 时间转轮 自定义控件
