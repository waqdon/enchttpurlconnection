package com.qdwang.lib.picker.lib;
...
import com.qdwang.lib.picker.adapter.WheelAdapter;
import com.qdwang.lib.picker.listener.OnItemSelectedListener;
import com.qdwang.lib.picker.model.IPickerViewData;
import com.qdwang.lib.utils.UiUtils;
...
//        textSize = getResources().getDimensionPixelSize(R.dimen.pickerview_textsize);//默认大小
        textSize = UiUtils.sp2px(getContext(), 20);//默认大小
