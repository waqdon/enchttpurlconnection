 ...
 * described：关于压缩图片需要的工具类，
 */
public enum BitmapCheckUtils {
    SINGLE;

    private static final String TAG = "BitmapCheckUtils";
    ...
    /**
     * 判断是否需要压缩
     * @param leastCompressSize 大于该值压缩，小于该值不再压缩
     * @param path 需要压缩的图片路劲
     * @return 返回结果，true压缩，false不压缩
     */
